...
class SetOfParliamentMembers:
    ...
    def display_chart(self):
        ...
        male_mps = data[data.sexe == 'M']
        
        
        counts = [len(female_mps), len(male_mps)]
        counts = pd.array(counts)
        nb_mps = counts.sum()
    ...
    def split_by_political_party(self):
        ...
        all_parties = data['parti_ratt_finiancier'].dropna().unique()
        for party in all_parties:
            data_subset = data[data.parti_ratt_finiancier == party]
    ...
    def launch_analysis(self,data_file, by_party=False):
